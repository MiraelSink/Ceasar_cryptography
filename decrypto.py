...
Encryptag = Label(left_frame,text = "DECRYPTAGE",font = ("Neuropol",30),bg = "#41b77f", fg = "white")
Encryptag.pack()
#partie gauche
width = 300
height = 300
image = PhotoImage(file="Decrypter.png").zoom(10).subsample(30)
...
crypt_button = Button(right_frame,text = 'Decrypter', bg='#41b7ff',fg='white',command = crypt,font = "Neuropol",relief = "groove")
crypt_button.pack(fill = X,pady = 10)
lbls = Label(right_frame,text = 'voici les données decryptées :',bg = '#41b77f',font = ("Adelia",15),fg = "white").pack(pady = 2)
